...
* TOC links work, but links in the document don't.
This is because the links are set up in the original pages to other different original pages.
When everything is glommed into one document, the links are still to the other pages, not the section of the big document.